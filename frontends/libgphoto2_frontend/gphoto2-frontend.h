...
int gpfe_file_image_rotate (CameraFile *old_file, CameraFile *new_file, int degrees);
int gpfe_file_image_scale  (CameraFile *old_file, CameraFile *new_file, int new_width, int new_height);
