...
uint8_t SPCA50xJPGDefaultHeaderPart1[SPCA50X_JPG_DEFAULT_HEADER_PART1_LENGTH] = {
	/* SOI(Start of Image) */
	0xFF,0xD8,
...
uint8_t SPCA50xJPGDefaultHeaderPart2[SPCA50X_JPG_DEFAULT_HEADER_PART2_LENGTH] = {
 ...
 */
uint8_t SPCA50xJPGDefaultHeaderPart3[SPCA50X_JPG_DEFAULT_HEADER_PART3_LENGTH] = {
	/* SOFn(Start of Frame) */
	0xFF,0xC0,
	0x00,0x11,
...
uint8_t SPCA50xOriginal_QTable_4NF_M[18][64]=		/* not Z-Z */
{
	/*  index 0, Q50 */
