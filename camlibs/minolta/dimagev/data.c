...
int dimagev_get_camera_data(dimagev_t *dimagev) {
	...
	switch ( char_buffer ) {
		...
		case DIMAGEV_CAN:
			...
			break;
		default:
			gp_debug_printf(GP_DEBUG_LOW, "dimagev", "dimagev_get_camera_data::camera responded with unknown value %x\n", char_buffer);
			return GP_ERROR_IO;
			break;
	}
...
int dimagev_send_data(dimagev_t *dimagev) {
	...
	switch ( char_buffer ) {
		...
		case DIMAGEV_CAN:
			...
			break;
		default:
			gp_debug_printf(GP_DEBUG_LOW, "dimagev", "dimagev_send_data::camera responded with unknown value %x\n", char_buffer);
			return GP_ERROR_IO;
			break;
	}
