...
#define  quantization_table1 \
    ...
    "\x18\x12\x14\x15\x14"
//*/
/* New table, but using a copy of quantization_table2 instead of 1
#define  quantization_table1 \
    "\xFF\xDB\x00\x43\x00\x03\x04\x04" "\x05\x04\x05\x09\x05\x05\x09\x14" \
...
#define SOFCO_320x128 \
    "\xFF\xC0\x00\x11\x08\x00\x80\x01" "\x40\x03\x01\x11\x01\x02\x21\x00" \
         "\x03\x11\x00"

#define SOFC0_640x248 \
    "\xFF\xC0\x00\x11\x08\x00\xf8\x02" "\x80\x03\x01\x11\x01\x02\x21\x01" \
         "\x03\x11\x00"
