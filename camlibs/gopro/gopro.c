/** \file gopro.c
 *
 * \author Copyright 2020 Marcus Meissner <marcus@jet.franken.de>
 *
 * \par
...
{                                                       \
	...
	\
	if (res < 0) {                                  \
		gp_log (GP_LOG_DEBUG, "gopro", "Operation failed in %s (%i)!", __FUNCTION__, res);     \
		return (res); 	\
	}                      	\
}
