...
camera_init (Camera *camera, GPContext *context)
{
	...
	camera->pl->params.cd_ucs2_to_locale = iconv_open(curloc, "UCS-2LE");
	camera->pl->params.cd_locale_to_ucs2 = iconv_open("UCS-2LE", curloc);
	camera->pl->params.cd_endian_correct = 1;
	if ((camera->pl->params.cd_ucs2_to_locale == (iconv_t) -1) ||
		...
		camera->pl->params.cd_endian_correct = 0;
		if ((camera->pl->params.cd_ucs2_to_locale == (iconv_t) -1) ||
		    (camera->pl->params.cd_locale_to_ucs2 == (iconv_t) -1)) {
